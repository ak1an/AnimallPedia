...
/**
 * Example component demonstrating how to use the Header component
 * This shows how to integrate the Header with Redux provider
 */
        ...
        <div className="container mx-auto px-4 py-8 pt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
              ...
              <ol className="list-decimal pl-5 text-gray-600 dark:text-gray-300 space-y-2">
                <li>Ensure Redux store is configured with theme, user, and search slices</li>
          ...
          <div className="mt-8 bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            ...
            <div className="text-gray-600 dark:text-gray-300 space-y-3">
              <p>
                The Header component is built with modularity in mind. Each sub-component 
              ...
              <p>
                The navigation menu is responsive, converting to a hamburger menu on mobile 
